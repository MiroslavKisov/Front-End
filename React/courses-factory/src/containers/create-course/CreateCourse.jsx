...
const CreateCourse = ({redirectPath, loading, createCourse, resetRedirectPath}) => {
  ...
  return (
    <div>
      ...
      <div className="form-container">
        <div className="w-2/5">
          <h1 className="text-center m-6 text-4xl text-teal-500">Create Course</h1>
...
const mapDispatchToProps = (dispatch) => {
  return {
    createCourse: (name, description) => dispatch(coursesActions.createCourse(name, description)),
